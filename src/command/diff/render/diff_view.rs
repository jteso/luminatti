...
use super::line_layout::{
    blank_line as blank_diff_line, expand_tabs as expand_tabs_in_spans,
    pad_background as pad_line_bg, push_wrapped_line as push_wrapped_diff_line,
    stripe_pattern as generate_stripe_pattern,
};
